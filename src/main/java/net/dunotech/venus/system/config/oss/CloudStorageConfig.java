...
public class CloudStorageConfig implements Serializable {
    ...
    //七牛路径前缀
    private static String qiniuPrefix;
    //七牛ACCESS_KEY
    ...
    private static String qcloudDomain;
    //腾讯云路径前缀
    private static String qcloudPrefix;
    //腾讯云AppId
    @NotNull(message="腾讯云AppId不能为空", groups = QcloudGroup.class)
    private static Integer qcloudAppId;
    //腾讯云SecretId
    ...
    private static String qcloudBucketName;
    //腾讯云COS所属地区
    @NotBlank(message="所属地区不能为空", groups = QcloudGroup.class)
    private static String qcloudRegion;
